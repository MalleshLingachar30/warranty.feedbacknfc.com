...
- BPL technician onboarding for installation and post-installation repair
- distributor technician onboarding through distributor-linked service centers
...
- calibration and scheduled-maintenance control during warranty
...
- distributor or dealer organization admin, where limited visibility is needed
- distributor service center manager
...
## 5.6A Technician and Service Center Onboarding

The platform must support two technician-onboarding models.

### BPL Technician Onboarding

This is especially important for capital items and other high-value equipment where BPL engineers undertake installation and post-installation repair.

The platform should support:

- creation of BPL-owned service centers, branches, or zones
- onboarding of BPL installation engineers
- onboarding of BPL repair/service technicians
- mapping of technicians to region, zone, branch, and service center
- activation/deactivation of technician accounts
- skill-tagging by equipment family or modality
- assignment eligibility for capital-item installation
- mobile login access for installation and service closure

Suggested BPL technician master fields:

- employee code
- full name
- mobile number
- email
- reporting branch / zone
- service center
- role type
- skill tags
- active status

### Distributor Technician Onboarding Through Service Center Creation

Where distributor-side execution is permitted for selected products, the platform should support:

- onboarding of distributor organizations
- creation of distributor-owned service centers
- mapping service centers to geography and distributor
- onboarding of distributor technicians under that service center
- assignment restrictions by product line, geography, or warranty policy
- approval workflow by BPL before technician activation where required

Suggested distributor service center master fields:
...
Suggested distributor technician master fields:
...
- email
- linked distributor
- linked service center
- skill tags
- active status
- approved by BPL flag

Business rule:

- for capital or other high-value installation-driven items, only BPL-authorized technicians should be permitted to complete installation and installation-triggered warranty activation unless BPL explicitly enables a different policy for a product family
...
- equipment under warranty may also be subject to scheduled maintenance and calibration obligations
- scheduled maintenance and calibration events must be planned, visible, and traceable against the installed machine
- completion of calibration or scheduled maintenance must create a dated service-history record against the machine
- missed or overdue calibration / scheduled-maintenance obligations must appear in exception reporting
- replaced spare warranty windows, such as 90-day replacement part warranty, should be configurable

## 5.9A Calibration and Scheduled Maintenance During Warranty

For equipment models that require periodic calibration or preventive maintenance during warranty, the platform must support:

- model-level maintenance frequency definition
- model-level calibration schedule definition
- auto-generation of due events after installation activation
- assignment of planned visits to BPL technicians or authorized service centers
- mobile completion of scheduled visits
- capture of maintenance checklist, calibration readings, and service remarks
- customer acknowledgement for completed scheduled visits where required

Suggested planned-event statuses:
...
Suggested calibration / scheduled-maintenance record fields:
...
- service center
- checklist responses
- calibration parameters / readings
- remarks
...
- machines with overdue calibration
- machines with overdue scheduled maintenance
...
- scrap / quality approver where discard authorization is controlled separately
...
6. Initial verification is performed to determine whether the item is potentially serviceable or should be discarded / condemned.
...
- initial serviceability assessment
- discard / condemn recommendation where applicable
- verification remarks
- receipt timestamp
- receiver identity

## 6.5A Initial Verification and Serviceability Decision

The first-stage verification must help BPL determine whether the received item is:

- serviceable and fit to enter repair flow
- serviceable only after estimate / approval
- usable for parts recovery only
- non-serviceable and to be discarded / condemned

The verification stage should capture:

- item completeness
- visible damage condition
- tampering or burn / corrosion observations
- serial or label availability
- serviceability decision
- discard reason where applicable
- verifier identity
- verification timestamp

If the item is marked non-serviceable:

- it should not proceed into the standard repair workflow
- it should move into a discard / condemnation approval flow
- the reason must remain visible for audit and reporting
...
- total items awaiting verification
- total items marked serviceable
- total items recommended for discard
...
- items awaiting initial verification beyond SLA
- items marked discard-pending but not approved
...
- service center or branch mapping where SAP or middleware holds it
- technician or employee master where available
...
- BPL technician onboarding
- distributor service-center onboarding
- distributor technician onboarding
- installation report based warranty activation
- calibration and scheduled-maintenance planning during warranty
...
- field technician: assigned jobs, scans, installation proof, calibration / maintenance closure, and service closure proof
- distributor service center manager: local technician onboarding, assignment visibility, and local operational reporting where permitted
- distributor technician: assigned jobs and service updates where permitted by product policy
...
- scrap / quality approver: discard approval and condemnation control
...
- distributor service-center onboarding
- distributor technician onboarding where policy allows
- ticket workflow
- spare linkage
...
## 13.3 Phase 3: Return Control, Calibration, and Exception Reporting

- zonal-office return ledger
- head-office receipt confirmation
- scheduled maintenance planning
- calibration scheduling and completion capture
